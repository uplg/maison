    ...
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {t('meross.electricityDescription')}
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      {consumptionData?.consumption && consumptionData.consumption.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {t('meross.consumptionDescription')}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-lg font-bold">
                {consumptionData.summary.totalKwh} kWh
              </span>
            </div>
            <div className="space-y-1.5 max-h-48 overflow-y-auto">
              {consumptionData.consumption.slice(-7).reverse().map((entry) => (
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="font-medium">{status.hardware?.type?.toUpperCase() || t('common.unknown')}</p>
            </div>
            <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <Link to={`/meross/${plug.id}`}>
                <CardTitle className="text-base hover:underline cursor-pointer">{plug.name}</CardTitle>
              </Link>
